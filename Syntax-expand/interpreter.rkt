...
(define syntax-expand
  (lambda (exp)
    (cases expression exp
      ...
      [var-exp (_) exp]
      [quote-exp (_) exp]
      [prim-exp (id body) exp] ;TODO
      [begin-exp (exps)
                 (app-exp (lambda-exp (list) (map syntax-expand exps)) (list))]
      
      ;LAMBDAS
      [lambda-exp (ids body) (lambda-exp ids (syntax-expand body))]
      [lambda-list-exp (ids body) (lambda-list-exp ids (syntax-expand body))]
      [lambda-improper-exp (ids body) (lambda-improp-exp ids (syntax-expand body))]
